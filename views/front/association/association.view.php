<?php ob_start();?>
<?= styleTitreNiveau1("Association Nos Amis - Nos Animaux (SPA-GENNEVILLIERS) <br/> GENNEVILLIERS (92230)", COLOR_ASSO);?>


<div class='row align-items-center mt-5'>
    <div class='col-12 col-lg-3 text-center '>
        <img class='img-fluid' src='<?= URL ?>public/sources/images/Autres/logoAnimaux.jpg' alt='image logo' />
    </div>
    <div class='col-12 col-lg-9'>
        ...
        <p>
            ...
            l'Association "NOS AMIS NOS ANIMAUX" (SPA-GENNEVILLIERS) est née !!!
        </p>
        <p>
